...
function initCampaignModal() {
  ...
  const HIDE_DAYS = parseInt(modal.getAttribute('data-hide-days')) || 3;
  const DELAY_MS = parseInt(modal.getAttribute('data-delay')) || 1800;
  ...
  // Gecikme süresi kadar sonra göster
  setTimeout(function () {
...
// ===================================
// İletişim Formu (Sadece statik şablonlar için simülasyon)
// ===================================
